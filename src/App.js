...
const App = props => {
  return (
    <div style={styles.container}>
      ...
      <div style={styles.oneline}><a href='https://goo.gl/maps/gkDqJ9L5cTNWCEcf9' target='_blank'>221 Normal Ave #B, Chico, CA 95928</a>, 11am - 8pm, except Tuesday</div><br/>
      ...
      <div style={styles.notice}><span style={styles.tagLine}>We close on Tuesday</span><br/></div>
      </div>
