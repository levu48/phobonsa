...
const App = props => {
  return (
    <div style={styles.container}>
      ...
      <div style={styles.notice}><span style={styles.tagLine}>We close for Easter</span><br/>
      <span style={styles.tagLine}>from Sunday 3/31 to Tuesday 4/2/2024</span><br/></div>
      </div>
