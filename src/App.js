...
const App = props => {
  return (
    <div style={styles.container}>
      ...
      <div style={styles.notice}><span style={styles.tagLine}>Sorry, we close on Sunday May 12th, 2024</span><br/>
      <span style={styles.tagLine}>Happy Mother's Day</span><br/></div> */}
      </div>
